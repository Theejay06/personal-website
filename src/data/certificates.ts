...
export const certificates: Certificate[] = [
  {
    ...
    image: `${import.meta.env.BASE_URL}certificates/thesis-seminar-a.png`,
    imageAlt: 'Certificate of Participation awarded to Theejay F. Tagama for Thesis: Far From Home on August 29, 2026.',
    documentUrl: `${import.meta.env.BASE_URL}certificates/thesis-seminar-a.pdf`,
  },
  {
    ...
    image: `${import.meta.env.BASE_URL}certificates/thesis-seminar-b.png`,
    imageAlt: 'Certificate of Participation awarded to Theejay F. Tagama for Thesis: Homecoming on August 14, 2026.',
    documentUrl: `${import.meta.env.BASE_URL}certificates/thesis-seminar-b.pdf`,
  },
  {
    id: 'philsec-2026',
    title: 'PhilSec 2026',
    ...
    image: `${import.meta.env.BASE_URL}certificates/philsec-2026.png`,
    imageAlt: 'Certificate presented to Theejay Tagama for volunteering at PhilSec on June 30 and July 1, 2026.',
    documentUrl: `${import.meta.env.BASE_URL}certificates/philsec-2026.pdf`,
  },
  {
    id: 'blockchain-2026',
    ...
    image: `${import.meta.env.BASE_URL}certificates/blockchain-2026.png`,
    imageAlt: 'Certificate of Participation awarded to Theejay F. Tagama for Getting Started with Blockchain on April 6, 2026.',
    documentUrl: `${import.meta.env.BASE_URL}certificates/blockchain-2026.png`,
  },
  {
    ...
    image: `${import.meta.env.BASE_URL}certificates/jpcs-membership.png`,
    ...
    documentUrl: `${import.meta.env.BASE_URL}certificates/jpcs-membership.pdf`,
  },
]
